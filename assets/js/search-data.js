    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-started-my-phd-at-the-max-planck-institute-for-intelligent-systems-in-the-optics-and-sensing-lab-oslab-where-i-am-supervised-by-dr-senya-polikovsky-and-prof-dr-xucong-zhang-my-research-focuses-on-multiview-gaze-estimation-through-the-use-of-social-interactions",
          title: 'I started my PhD at the Max Planck Institute for Intelligent Systems in...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/your_cv.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%74%75%6E%61.%67%75%65%72%62%75%65%7A@%74%75%6D.%64%65", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/ge75xuv", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/tuna-gürbüz-runtime/", "_blank");
        },
      },{
      id: 'light-theme',
